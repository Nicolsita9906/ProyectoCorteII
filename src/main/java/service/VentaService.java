...
public class VentaService {
    ...
    public VentaService(VentaRepository servicio, ProductoRepository productoRepo, EmpleadoRepository empleadoRepo) {
        this.servicio = servicio;
        this.prod = new ProductoService(productoRepo);
        this.emp = new EmpleadoService(empleadoRepo);
        datosMuertos();
    }
